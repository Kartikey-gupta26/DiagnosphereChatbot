...
with st.sidebar:
    ...
    analyze_report = st.toggle("Analyze Uploaded Report", value=True)

# System Prompt
SYSTEM_PROMPT = SystemMessagePromptTemplate.from_template(
    "You are an expert AI medical assistant. Provide diagnoses based on symptoms or suggest home remedies, "
